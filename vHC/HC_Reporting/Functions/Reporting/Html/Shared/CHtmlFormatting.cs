...
namespace VeeamHealthCheck.Functions.Reporting.Html.Shared
{
    internal class CHtmlFormatting
    {
        ...
        public string SetHeaderAndLogo(string licenseHolder)
        {
            ...
            //string s = "<h1 style=\"background: #00d15f; color: white;text-align:center\">";
            //s += "<a class=\"logo\">";
            ...
            //s += licenseHolder;
            //s += LineBreak();
            //s += "<a style=\"font-size:16px\">" + string.Format(DateTime.Now.ToString("MM-dd-yyyy") + LineBreak() + CGlobals.ReportDays.ToString() + " day report") + "</a>";
            //s += "</h1>";

            string s = String.Format(@"
<h1 style='background: #00d15f; color: white; text-align:center'>
    <a class=logo>  
        {0}
    </a>
...
", licenseHolder, DateTime.Now.ToString("MMMM dd yyyy"), CGlobals.ReportDays.ToString(), " day report");
