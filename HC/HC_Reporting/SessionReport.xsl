...
>
	...
	<xsl:template name="user.header.content"  match="/root/header">
		...
		<html>
			...
			<body>
				<div id="top"></div>
				<HR/>
				<h1 style="background: black; color: green; font-family: tahoma;text-align:center">
					<a class="logo">
					...
					<a class="GenText">
						...
						<br></br><br></br>
						Note - During mouseover, a tool tip may appear containing explanatory data of the table header or data column.
						<br></br><br></br>
						Note - The tool you ran to generate this report is completely self-contained, does not ‘phone-home’ and was only executed on your Veeam Backup and Replication server. It queries the VBR database, registry, configuration and log files. It does not require access to vCenter or any other infrastructure.
						<br>
							<br></br>
						</br>
	...
	<xsl:template match="/root/npjobSummary" name="npLoads">
		<div id="npJobSummary">
			...
			<br></br>
			<a class="hdr">Summary:</a>
			<br></br>
			<a class="subtext">This table summarizes job types that are either missing from your environment or could not be analyzed. Please consult with your Veeam Engineer for more information.</a>
			<br></br>
			<br></br>
	...
	<xsl:template match="/root/serverSummary">
		<html>
			<body>
				<h3>
					Detected Infrastructure Types <h5>
						<!--Summary of servers manually added into Veeam<br></br>-->
						<a class="subtext">
							<xsl:value-of select="info"/>
						</a>
	...
	<xsl:template match="/root/repositories">
		...
		<html>
			<body>
				<h3>
					Standalone Repository Details<h5>
						<!--Summary of servers manually added into Veeam<br></br>-->
						<xsl:value-of select="info"/>
					</h5>
				</h3>
	...
	<xsl:template match="/root/concurrencyChart_job7">
		<div id="jobConcurrency7"></div>
		<html>
			<body>
				<h3>
					Job Concurrency Table (7 days)<h5>
					</h5>
				</h3>
				<table border="1">
					<tr bgcolor="##00b050">
	...
	<xsl:template match="/root/concurrencyChart_task7">
		<div id="jobConcurrency31"></div>
		<html>
			<body>
				<h3>
					Task Concurrency Table (7 days)<h5>
						This table shows total concurrent tasks at any given hour of the day over the past 7 days. <!--Summary of servers manually added into Veeam<br></br>-->
					</h5>
				</h3>
				<table border="1">
					<tr bgcolor="##00b050">
